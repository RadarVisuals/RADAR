...
// FIX: Default to 0 (Uncapped/Native) instead of 120 to avoid software overhead
...
export const useEngineStore = create(
  subscribeWithSelector(
    persist(
      ...
      {
        name: 'radar_engine_config', // Name for localStorage key
        storage: createJSONStorage(() => localStorage), 
        // Only persist maxFPS, sequencer state, and audio settings
        partialize: (state) => ({ 
            maxFPS: state.maxFPS,
            sequencerState: state.sequencerState,
